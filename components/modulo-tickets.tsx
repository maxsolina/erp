...
import { 
  Search, Plus, Filter, ArrowLeft, Send, Paperclip, Clock, 
    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          <button onClick={() => setCreandoTicket(false)} className="text-gray-500 hover:text-gray-700">
    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-start gap-4 mb-6">
          <button onClick={() => setSelectedTicket(null)} className="text-gray-500 hover:text-gray-700 mt-1">
            <ArrowLeft className="w-5 h-5" />
          </button>
