  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Categorías de Ubicaciones", href: "/stock/config/categorias", permKey: "config_categorias", icon: Tag },
        { label: "Tipos de Operación", href: "/stock/config/tipos-operacion", permKey: "config_tipos_operacion", icon: Layers },
        { label: "Posiciones de Ubicaciones", href: "/stock/config/posiciones", permKey: "config_posiciones", icon: MapPin },
        { label: "Rutas", href: "/stock/config/rutas", permKey: "config_rutas", icon: Route },
        { label: "Reglas", href: "/stock/config/reglas", permKey: "config_reglas", icon: Settings },
      ],
    },
  ],
}
