...
// Las rutas con form complejo (NC, ND, Seña, Ajustes, Categorías)
...
// NV, OE, Remitos, Facturas y Recibos: listado + ficha read-only extraídos; creación/edición sigue en el monolito.
