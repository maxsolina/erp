...
// Las rutas con form complejo (Seña, Categorías, Criterios)
...
// NV, OE, Remitos, Facturas, Recibos, Ajustes, NC y ND: listado + ficha read-only extraídos; creación/edición sigue en el monolito.
