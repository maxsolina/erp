...
// Las rutas con form complejo (Recibos, NC, ND, Seña, Ajustes, Categorías)
...
// NV, OE, Remitos y Facturas: listado + ficha read-only extraídos; creación/edición sigue en el monolito.
