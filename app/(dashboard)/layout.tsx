...
function DashboardShell({ children }: { children: ReactNode }) {
  ...
  if (restaurandoSesion) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-900 via-indigo-800 to-amber-900 text-white">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-semibold tracking-wide">Cell Home ERP</h1>
            <p className="text-sm text-white/70 mt-1">Iniciando…</p>
          </div>
