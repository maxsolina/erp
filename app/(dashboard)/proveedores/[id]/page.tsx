...
import ProveedorFicha from "@/components/proveedores/ficha"

export default function ProveedorFichaPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="flex-1 overflow-auto p-6">
        <ProveedorFicha proveedorId={proveedorId} />
      </div>
    </div>
  )
}
